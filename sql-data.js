// Auto-extracted from Fraud_Analytics.sql — full text of each of the 10 NexaBank investigations
const sqlQueries = {
  q1: {
    title: "Resource Allocation — Under vs. Over-Policed Fraud Patterns",
    code: `/*
...
ORDER BY resource_efficiency_gap DESC;`
  ...
  q2: {
    title: "Year-over-Year Evolution — Are Attacks Getting Smarter?",
    code: `/*
...
ORDER BY
  ...
  q3: {
    title: "Synthetic Identity — Fabricated-Identity Scoring",
    code: `/*
...
ORDER BY synthetic_id_suspicion_score DESC NULLS LAST;`
  ...
  q4: {
    title: "Money Mule / AML — SAR Filing Candidates",
    code: `/*
...
ORDER BY mule_suspicion_score DESC;`
  ...
  q5: {
    title: "Ring Contagion — Speed of Fraud-Ring Spread",
    code: `/*
...
ORDER BY first_replication_speed_days ASC;   -- rings with least time to act, first`
  ...
  q6: {
    title: "Cross-Subsidy — Fraud Tax by Customer Segment",
    code: `/*
...
ORDER BY net_dollar_subsidy_effect DESC;`
  ...
  q7: {
    title: "Attack Window — The Perfect Fraud Recipe",
    code: `/*
...
LIMIT 25;`
  ...
  q8: {
    title: "Response Lag Cost — Dollar Cost of Investigation Delay",
    code: `/*
...
ORDER BY preventable_loss_usd DESC;`
  ...
  q9: {
    title: "Pre-Crime Drift — Early-Warning Candidates",
    code: `/*
...
ORDER BY drift_signals_positive DESC, ip_drift DESC;`
  ...
  q10: {
    title: "Pattern Evolution — Which Fraud Teaches the Rest?",
    code: `/*
